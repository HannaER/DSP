...
Debug/create_subsets.doj :create_subsets.c $(VDSP)/212xx/include/stdio.h $(VDSP)/212xx/include/stdio_21xxx.h constants.h 
...
Debug/matching.doj :matching.c $(VDSP)/212xx/include/stdio.h $(VDSP)/212xx/include/stdio_21xxx.h constants.h 
	@echo ".\matching.c"
...
Debug/pre_emph.doj :pre_emph.c $(VDSP)/212xx/include/stdio.h $(VDSP)/212xx/include/stdio_21xxx.h constants.h $(VDSP)/212xx/include/filter.h $(VDSP)/212xx/include/complex.h 
	@echo ".\pre_emph.c"
	$(VDSP)/cc21k.exe -c .\pre_emph.c -file-attr ProjectName=speechrecognition -g -structs-do-not-overlap -no-multiline -double-size-32 -warn-protos -si-revision 0.1 -proc ADSP-21262 -o .\Debug\pre_emph.doj -MM
...
Debug/setup.doj :setup.c setup.h database.h $(VDSP)/212xx/include/stdio.h $(VDSP)/212xx/include/stdio_21xxx.h $(VDSP)/212xx/include/stdlib.h framework.h 
	@echo ".\setup.c"
	$(VDSP)/cc21k.exe -c .\setup.c -file-attr ProjectName=speechrecognition -g -structs-do-not-overlap -no-multiline -double-size-32 -warn-protos -si-revision 0.1 -proc ADSP-21262 -o .\Debug\setup.doj -MM

Debug/speechrecognition.doj :speechrecognition.c $(VDSP)/212xx/include/stdio.h $(VDSP)/212xx/include/stdio_21xxx.h Levinson.h constants.h rm_noise.h pre_emph.h level_detect.h buffer.h cut.h $(VDSP)/212xx/include/complex.h $(VDSP)/212xx/include/stats.h $(VDSP)/212xx/include/stdlib.h $(VDSP)/212xx/include/errno.h $(VDSP)/212xx/include/yvals.h $(VDSP)/212xx/include/string.h fft_.h getX.h test_signal.h 
